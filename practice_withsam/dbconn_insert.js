...
// 같은 id 로 book이나 customer에 insert를 여러번 실행시키면 오류가 나기 때문에
// insert 는 sales 테이블로 진행함
// sql injection 방지를 위해 prepared statements 를 사용함
const sql = `insert into sales(brand, amount) values (?,?);`; 
